...
def lifecycle(sim, sol, par):
    ...
    c = sim.c
    a = sim.a
    l = sim.l  # Add labor as a choice variable in the simulation
    ...
    for t in range(par.simT):
        for i in prange(par.simN):  # in parallel
            ...
            a[t, i] = m[t, i] - c[t, i]
            l[t, i] = linear_interp.interp_2d(par.grid_p, par.grid_m, sol.l[t], p[t, i], m[t, i])  # Add labor choice in the simulation
