...
class model_bufferstock():
    ...
    def setup(self):
        ...
        ## Shock grid settings
        par.Neps = 4 # number of quadrature points for eps
        par.Npsi = 4 # number of quadrature points for psi
